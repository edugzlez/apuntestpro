...
\item[]
 \begin{prooftree}
    ...
    \LeftLabel{}
    \RightLabel{}
    \BinaryInfC{$\la{a_1 \n{ op }s a_2}{s}\rightarrow_A z_1 * z_2$}
\end{prooftree}
...
\end{prooftree}
 ...
 \begin{prooftree}
    ...
    \LeftLabel{}
    \RightLabel{}
    \BinaryInfC{$\la{a_1 = a_2}{s}\rightarrow_A X$}
    \end{prooftree}
...
\begin{prooftree}
    ...
    \LeftLabel{}
    \RightLabel{}
    \BinaryInfC{$\la{a_1 \leq s a_2}{s}\rightarrow_A X$}
        \end{prooftree}
...
\begin{prop} Si $S_1$ y $S_2$ son semánticamente equivalente si y solo si
\[
        \mc{S}_\nn{sos}[[S_1]] = \mc{S}_\nn{sos}[[S_2]]
\] 
